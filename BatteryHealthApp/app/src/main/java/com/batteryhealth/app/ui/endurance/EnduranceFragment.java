...
public class EnduranceFragment extends Fragment {
    ...
    private void animateEntry(View view) {
        try {
            ...
            Log.e(TAG, "animateEntry failed", e);
        }
    }
    ...
    private void updateBatteryData() {
        try {
            ...
            Log.e(TAG, "updateBatteryData failed", e);
        }
    }
    ...
    private void updateFromIntent(Intent intent) {
        try {
            ...
            if (tvEnduranceHours == null) return;
            ...
            Log.e(TAG, "updateFromIntent failed", e);
        }
    }

    private void updatePowerRanking() {
        if (getView() == null) return;
        if (tvScreenPower == null || tvSystemPower == null || tvAppsPower == null) return;
        if (lastAnalysisResult != null) {
    ...
    private void updateWearableData() {
        if (getView() == null) return;
        if (tvWearableStatus == null || tvWearableBattery == null || tvWearableEndurance == null) return;
    ...
    private long queryScreenOnTime() {
        ...
        if (!BatteryConsumptionAnalyzer.hasUsageAccess(ctx)) {
            return 0;
        }
        try {
            UsageStatsManager usm = (UsageStatsManager) ctx
