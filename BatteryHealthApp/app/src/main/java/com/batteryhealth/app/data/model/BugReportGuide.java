...
public class BugReportGuide {
    ...
    static {
        BRAND_GUIDES.put("xiaomi", new BrandGuide(
                ...
                new String[]{
                        "1. 打开 \"设置\" → \"我的设备\"",
                        "2. 连续点击 \"MIUI 版本\" 7次，开启开发者选项",
                        "3. 返回设置主页，进入 \"更多设置\" → \"开发者选项\"",
                        "4. 开启 \"USB 调试\" 和 \"USB 安装\"",
                        "5. 电脑安装小米助手或使用 ADB 工具",
                        "6. 连接手机后在电脑命令行执行 adb 命令"
                },
                new String[]{
                        "adb devices",
                ...
                new String[]{
                        "需要先在手机上授权电脑连接",
                        "MIUI 14+ 需要在开发者选项中开启 \"USB 调试（安全设置）\"",
        ...
        BRAND_GUIDES.put("oneplus", new BrandGuide(
                ...
                new String[]{
                        "OxygenOS 需要在开发者选项中开启 \"USB 调试（安全设置）\"",
                        "部分机型需要在开发者选项中开启 \"网络安全调试\"",
                        "建议使用原装数据线"
                },
                "OxygenOS 自带 \"反馈\" 应用，可以直接提交问题和日志"
        ));
    ...
    public static List<BrandGuide> getAllGuides() {
        return new ArrayList<>(BRAND_GUIDES.values());
    }
