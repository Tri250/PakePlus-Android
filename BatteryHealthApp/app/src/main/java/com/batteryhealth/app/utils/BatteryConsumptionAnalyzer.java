...
public class BatteryConsumptionAnalyzer {
    ...
    public static final class Result {
        ...
        public final double screenPowerPercent;         // 屏幕耗电占比
        public final double systemPowerPercent;         // 系统耗电占比
        public final double appsPowerPercent;           // 应用耗电占比

        public Result(long capacity, double hours, double screenHours, List<AppConsumption> list,
                      boolean hasUsageAccessPermission) {
            this(capacity, hours, screenHours, list, hasUsageAccessPermission, 0, 0, 0);
        }

        public Result(long capacity, double hours, double screenHours, List<AppConsumption> list,
                      boolean hasUsageAccessPermission, double screenPowerPercent,
                      double systemPowerPercent, double appsPowerPercent) {
