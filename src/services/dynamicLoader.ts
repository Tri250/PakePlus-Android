...
const MODULE_CONFIGS: Record<string, ModuleConfig> = {
  ...
  'lbs-radar': {
    id: 'lbs-radar',
    name: 'LBS雷达',
    path: './services/lbsRadar',
    priority: 'high',
    dependencies: ['map', 'collector'],
    preload: false,
    cacheEnabled: true,
    timeout: 10000,
  },
  ...
  'competitor': {
    id: 'competitor',
    name: '竞品监控',
    path: './services/competitorMonitor',
    priority: 'medium',
    dependencies: ['map'],
    preload: false,
    cacheEnabled: true,
